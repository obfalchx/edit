...
local Tabs = {
    ...
    Teleport = Window:AddTab({ Title = "Tab Tele đảo",
    Fruit = Window:AddTab({ Title = "Tab Trái",
    Sea Event = Window:AddTab({ Title = "Tab Sự kiện biển",
    Raid = Window:AddTab({ Title = "Tab Tập kích",
    Race = Window:AddTab({ Title = "Tab Tộc V4",
    Shop = Window:AddTab({ Title = "Tab Cửa hàng",
  	Misc = Window:AddTab({ Title = "Tab Khác",
    Hop = Window:AddTab({ Title = "Tab Đổi sever",
...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "welcome to Alchems Hub" , 6 ,16556815954 )
	DiscordLib:Notification("Thông Báo" , "vào discord alchems để hưởng quyền công dân" , 6 ,16556815954 )
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {
    ...
    Description = "(Farm quái và đánh kata)", 
    Default = false })
...
local RoughSea =Tabs.Sea Event:AddSection(" Kitsune ")


      local ToggleEspKitsune = Tabs.Sea Event:AddToggle("ToggleEspKitsune", {Title = "Định vị Đảo kisune",Description = "", Default = false })
      ...
      local ToggleTPKitsune = Tabs.Sea Event:AddToggle("ToggleTPKitsune", {Title = "Bay Đến Đảo Kisune",Description = "", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Sea Event:AddToggle("ToggleCollectAzure", {Title = "Nhặt Linh Hồn",Description = "", Default = false })
...
if Third_Sea then
    local RoughSea = Tabs.Sea Event:AddSection("Rough Sea")
    ...
    local ToggleTerrorshark = Tabs.Sea Event:AddToggle("ToggleTerrorshark", {Title = " Giết Cá Mẹ",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Sea Event:AddToggle("TogglePiranha", {Title = " Giết Piranha",Description = "", Default = false })
     ...
     local ToggleShark = Tabs.Sea Event:AddToggle("ToggleShark", {Title = "Giết Cá Mập Con",Description = "", Default = false })
    ...
    local ToggleFishCrew = Tabs.Sea Event:AddToggle("ToggleFishCrew", {Title = " Giết Fish Crew",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.Sea Event:AddToggle("ToggleShip", {Title = "Đánh Thuyền Nhỏ",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Sea Event:AddToggle("ToggleGhostShip", {Title = "Đánh Thuyền Ma",Description = "",Default = false })
